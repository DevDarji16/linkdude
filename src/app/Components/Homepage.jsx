...
const Homepage = () => {
  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <section className={`${theme==='dark'?'bg-gray-100 text-white':'bg-black text-white'} relative py-16 `}>
      ...
      <div className={`${theme==='dark'?'bg-gray-200 text-black':'bg-black text-white'} p-2 pb-20 flex flex-col items-center relative  z-30 w-screen  `}>
        <motion.div
        ...
        <div className='mt-10 z-10 flex select-none flex-wrap gap-4 justify-center'>
          <div className={` rounded-xl relative border cursor-pointer w-72 h-52 p-7 flex flex-col items-center`}>
          
            <Image src="/images/signup.png" width={20} height={20} alt='Signup image' className='h-12 w-12 ' />
            <div className='font-myfont text-[19px] mt-2'>Sign Up</div>
            <div className='mt-4'>Create an account- Start for free</div>
          </div>
          <div className='rounded-xl cursor-pointer border w-72 h-52 p-7 flex flex-col items-center'>
            <Image src="/images/add.png" width={20} height={20} alt='add image' className='h-12 w-12' />
          ...
          <div className='rounded-xl cursor-pointer border w-72 h-52 p-7 flex flex-col items-center'>
            <Image src="/images/spaces.png" alt='spaces image' width={20} height={20} className='h-12 w-12' />
          ...
          <div className='rounded-xl cursor-pointer border w-72 h-52 p-7 flex flex-col items-center'>
            <Image src="/images/send.png" width={20} height={20} alt='Publish image' className='h-12 w-12' />
