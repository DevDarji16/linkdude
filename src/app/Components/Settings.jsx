  ...
  const { setLoggedInData } = useContext(LoggedIn);
    ...
    return (
        <div className='relative ' onClick={(e) => e.stopPropagation()}>
            <div className={`${settings ? 'opacity-100' : 'opacity-0 pointer-events-none'} w-52   duration-300 transition-all ease-in-out rounded-lg flex flex-col ${theme === 'light' ? 'bg-[#181b1e] text-white' : 'bg-gray-100'} items-center absolute bottom-22 sm:bottom-14 left-8  shadow-lg border p-2`}>
