    ...
    <div onClick={() => { spaceChange === null ? '' : setSpaceChange(null) }}>
      ...
      <div>
        ...
        <div className='flex flex-wrap gap-4'>
          ...
          }} className='h-36 w-36 cursor-pointer rounded-3xl hover:text-white relative border  hover:bg-black transition-all duration-200  flex flex-col justify-center items-center'>
          ...
          {props.spaces.map((space, index) => {
            return <div key={index}
              className=' h-36 w-36 rounded-3xl relative hover:text-white  border  hover:bg-black transition-all duration-200  flex flex-col justify-center items-center'>
